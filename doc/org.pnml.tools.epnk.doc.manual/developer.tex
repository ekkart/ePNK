...
let us discuss some details of the implementation of this {\sf handle()} method shown in
...
\begin{figure}[htbp!]
\lstinputlisting[firstnumber=39,label=lst:developer:applications:handlers:PTActionHandler2,tabsize=2,stringstyle=\small,%
caption={Action handler of Simulator (part2)}]%
