 ...
 * @generated
 */
public class GEditorInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new GEditorNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				GeometryEditPart.MODEL_ID));
		GEditorDiagramEditorUtil.runWizard(getShell(), wizard,
