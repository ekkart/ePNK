...
import geditor.diagram.edit.commands.ArcCreateCommand;
import geditor.diagram.edit.commands.ArcReorientCommand;
...
public class PointItemSemanticEditPolicy extends
	...
	public PointItemSemanticEditPolicy() {
		super(GEditorElementTypes.Point_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (GEditorVisualIDRegistry.getVisualID(incomingLink) == ArcEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (GEditorVisualIDRegistry.getVisualID(outgoingLink) == ArcEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (GEditorElementTypes.Arc_4001 == req.getElementType()) {
