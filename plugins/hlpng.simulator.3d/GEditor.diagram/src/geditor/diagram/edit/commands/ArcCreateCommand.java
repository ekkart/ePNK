...
public class ArcCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Point) {
			return false;
		}
		if (target != null && false == target instanceof Point) {
			return false;
		}
		if (getSource() == null) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Arc newElement = GeditorFactory.eINSTANCE.createArc();
		getContainer().getGeometryObjects().add(newElement);
		newElement.setStart(getSource());
	 ...
	 * @generated
	 */
	private static Geometry deduceContainer(EObject source, EObject target) {
