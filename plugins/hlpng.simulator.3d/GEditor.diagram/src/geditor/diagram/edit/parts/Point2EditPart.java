...
import geditor.diagram.edit.policies.GEditorTextSelectionEditPolicy;
 ...
 * @generated
 */
public class Point2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				GEditorVisualIDRegistry
						.getType(geditor.diagram.edit.parts.Point2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public Point2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new GEditorTextSelectionEditPolicy());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof GEditorTextSelectionEditPolicy) {
			((GEditorTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof GEditorTextSelectionEditPolicy) {
			((GEditorTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this,
					...
					GEditorEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
