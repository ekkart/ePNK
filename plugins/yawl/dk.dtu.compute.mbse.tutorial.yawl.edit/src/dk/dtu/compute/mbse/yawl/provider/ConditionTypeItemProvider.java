...
/**
 * This is the item provider adapter for a {@link dk.dtu.compute.mbse.yawl.ConditionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionTypeItemProvider extends AttributeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConditionType_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConditionType_text_feature", "_UI_ConditionType_type"),
				 YawlPackage.Literals.CONDITION_TYPE__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		CType labelValue = ((ConditionType)object).getText();
