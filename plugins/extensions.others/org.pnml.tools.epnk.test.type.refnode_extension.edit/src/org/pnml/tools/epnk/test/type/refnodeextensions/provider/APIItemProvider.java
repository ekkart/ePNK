...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.test.type.refnodeextensions.API} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class APIItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_API_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_API_text_feature", "_UI_API_type"),
				 RefnodeextensionsPackage.Literals.API__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((API)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(API.class)) {
			case RefnodeextensionsPackage.API__TEXT:
