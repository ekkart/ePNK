...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.test.type.refnodeextensions.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RefnodeextensionsPackage.Literals.PAGE__PRAGMATICS);
			childrenFeatures.add(RefnodeextensionsPackage.Literals.PAGE__API);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 RefnodeextensionsFactory.eINSTANCE.createRefPlace()));

		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 RefnodeextensionsFactory.eINSTANCE.createRefTransition()));

		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 RefnodeextensionsFactory.eINSTANCE.createPage()));
		...
		newChildDescriptors.add
			(createChildParameter
				(RefnodeextensionsPackage.Literals.PAGE__PRAGMATICS,
				 RefnodeextensionsFactory.eINSTANCE.createPragmatics()));

		newChildDescriptors.add
			(createChildParameter
				(RefnodeextensionsPackage.Literals.PAGE__API,
