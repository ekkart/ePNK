...
/**
 * This is the item provider adapter for a {@link dk.dtu.imm.se.pngen.att.test.blockstructure.Loop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoopItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Loop_back_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Loop_back_feature", "_UI_Loop_type"),
				 BlockstructurePackage.Literals.LOOP__BACK,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BlockstructurePackage.Literals.LOOP__BODY);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Loop_type") + " " + loop.isStartsafe();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BlockstructurePackage.Literals.LOOP__BODY,
				 BlockstructureFactory.eINSTANCE.createAtomic()));

		newChildDescriptors.add
			(createChildParameter
				(BlockstructurePackage.Literals.LOOP__BODY,
				 BlockstructureFactory.eINSTANCE.createChoice()));

		newChildDescriptors.add
			(createChildParameter
				(BlockstructurePackage.Literals.LOOP__BODY,
				 BlockstructureFactory.eINSTANCE.createSequence()));

		newChildDescriptors.add
			(createChildParameter
				(BlockstructurePackage.Literals.LOOP__BODY,
				 BlockstructureFactory.eINSTANCE.createLoop()));
	}
