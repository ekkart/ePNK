 ...
 * @generated
 */
public class BlockstructureSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BlockstructurePackage.BLOCK: {
				Block block = (Block)theEObject;
				T result = caseBlock(block);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BlockstructurePackage.ATOMIC: {
				Atomic atomic = (Atomic)theEObject;
				T result = caseAtomic(atomic);
				if (result == null) result = caseBlock(atomic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BlockstructurePackage.COMPOSITE: {
			...
			case BlockstructurePackage.CHOICE: {
				Choice choice = (Choice)theEObject;
				T result = caseChoice(choice);
				if (result == null) result = caseComposite(choice);
				if (result == null) result = caseBlock(choice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BlockstructurePackage.SEQUENCE: {
			...
			case BlockstructurePackage.LOOP: {
