...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.pntypes.inhibitornets.ArcType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArcTypeItemProvider
	 ...
	 * @generated
	 */
	public ArcTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InhibitornetsPackage.Literals.ARC_TYPE__TEXT,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ArcType"));
	}
	...
	public String getText(Object object) {
		ArcTypes labelValue = ((ArcType)object).getText();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ArcType_type") :
			getString("_UI_ArcType_type") + " " + label;
	}
