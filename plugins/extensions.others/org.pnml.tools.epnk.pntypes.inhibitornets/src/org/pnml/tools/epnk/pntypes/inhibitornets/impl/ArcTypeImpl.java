 ...
 * <ul>
 *   <li>{@link org.pnml.tools.epnk.pntypes.inhibitornets.impl.ArcTypeImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.pnml.tools.epnk.pntypes.inhibitornets.impl.ArcTypeImpl#getArc <em>Arc</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArcTypeImpl extends AttributeImpl implements ArcType {
	 ...
	 */
	public Arc getArc() {
		if (eContainerFeatureID() != InhibitornetsPackage.ARC_TYPE__ARC) return null;
	...
	public NotificationChain basicSetArc(Arc newArc, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newArc, InhibitornetsPackage.ARC_TYPE__ARC, msgs);
		return msgs;
	}
	...
	public void setArc(Arc newArc) {
		if (newArc != eInternalContainer() || (eContainerFeatureID() != InhibitornetsPackage.ARC_TYPE__ARC && newArc != null)) {
			...
			if (newArc != null)
				msgs = ((InternalEObject)newArc).eInverseAdd(this, InhibitornetsPackage.ARC__TYPE, Arc.class, msgs);
			msgs = basicSetArc(newArc, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InhibitornetsPackage.ARC_TYPE__ARC, newArc, newArc));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InhibitornetsPackage.ARC_TYPE__ARC:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case InhibitornetsPackage.ARC_TYPE__ARC:
				return eInternalContainer().eInverseRemove(this, InhibitornetsPackage.ARC__TYPE, Arc.class, msgs);
		}
