 ...
 * @generated
 */
public class InhibitornetsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InhibitornetsPackage.INHIBITOR_NET: {
				InhibitorNet inhibitorNet = (InhibitorNet)theEObject;
				T result = caseInhibitorNet(inhibitorNet);
				if (result == null) result = casePetriNetType(inhibitorNet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InhibitornetsPackage.PLACE: {
			...
			case InhibitornetsPackage.MARKING: {
			...
			case InhibitornetsPackage.ARC_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Inhibitor Net</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Inhibitor Net</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInhibitorNet(InhibitorNet object) {
		return null;
	}
