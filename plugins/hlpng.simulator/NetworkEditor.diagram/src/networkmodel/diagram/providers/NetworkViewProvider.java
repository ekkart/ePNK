 ...
 * @generated
 */
public class NetworkViewProvider extends AbstractProvider implements
        IViewProvider
{
	...
	protected boolean provides(CreateNodeViewOperation op)
	{
		...
		if(op.getSemanticHint() == null)
		{
			...
			visualID = NetworkVisualIDRegistry.getNodeVisualID(
		...
		else
		{
			...
			if(elementType != null)
			{
				if(!NetworkElementTypes.isKnownElementType(elementType)
	...
	protected boolean provides(CreateEdgeViewOperation op)
	{
		...
		int visualID = NetworkVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if(domainElement != null
		        && visualID != NetworkVisualIDRegistry
	        ...
	        PreferencesHint preferencesHint)
	{
		...
		{
			visualID = NetworkVisualIDRegistry.getNodeVisualID(containerView,
			        domainElement);
		}
		else
		{
			visualID = NetworkVisualIDRegistry.getVisualID(semanticHint);
		}
		switch(visualID)
		{
			case CategoryEditPart.VISUAL_ID:
	        ...
	        PreferencesHint preferencesHint)
	{
		...
		switch(NetworkVisualIDRegistry.getVisualID(elementTypeHint))
		{
			...
			case UndirectedEdgeEditPart.VISUAL_ID:
				return createUndirectedEdge_4002(
				        getSemanticElement(semanticAdapter), containerView,
				        index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Edge createUndirectedEdge_4002(EObject domainElement,
	        View containerView, int index, boolean persisted,
	        PreferencesHint preferencesHint)
	{
		Connector edge = NotationFactory.eINSTANCE.createConnector();
	...
	private void stampShortcut(View containerView, Node target)
	{
		        ...
		        .getModelID(containerView)))
		{
			...
			shortcutAnnotation.getDetails().put(
			        "modelID", NetworkEditPart.MODEL_ID); //$NON-NLS-1$
