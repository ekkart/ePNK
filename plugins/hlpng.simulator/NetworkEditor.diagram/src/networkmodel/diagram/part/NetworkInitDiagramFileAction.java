 ...
 * @generated
 */
public class NetworkInitDiagramFileAction implements IObjectActionDelegate
{
	...
	public void run(IAction action)
	{
		...
		Wizard wizard = new NetworkNewDiagramFileWizard(domainModelURI,
		        diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
		        NetworkEditPart.MODEL_ID));
		NetworkDiagramEditorUtil.runWizard(getShell(), wizard,
