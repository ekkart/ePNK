 ...
 * @generated
 */
public class UndirectedEdgeCreateCommand extends EditElementCommand
{
	 ...
	 * @generated
	 */
	public UndirectedEdgeCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute()
	{
		...
		return NetworkBaseItemSemanticEditPolicy.getLinkConstraints()
		        .canCreateUndirectedEdge_4002(getContainer(), getSource(),
		                getTarget());
	}
	        ...
	        IAdaptable info) throws ExecutionException
	{
		...
		UndirectedEdge newElement = NetworkmodelFactory.eINSTANCE
		        .createUndirectedEdge();
		getContainer().getNetwork().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(UndirectedEdge newElement,
