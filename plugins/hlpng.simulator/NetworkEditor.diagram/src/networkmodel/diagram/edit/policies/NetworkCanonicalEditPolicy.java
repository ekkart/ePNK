...
public class NetworkCanonicalEditPolicy extends CanonicalEditPolicy
{
	...
	protected List getSemanticChildrenList()
	{
		...
		List<NetworkNodeDescriptor> childDescriptors = NetworkDiagramUpdater
	...
	protected void refreshSemantic()
	{
		...
		for(Iterator<NetworkNodeDescriptor> descriptorsIterator = childDescriptors
	...
	private Collection<IAdaptable> refreshConnections()
	{
		...
		Collection<NetworkLinkDescriptor> linkDescriptors = collectAllLinks(
		        ...
		        .hasNext();)
		{
			...
			int diagramLinkVisualID = NetworkVisualIDRegistry
			...
			for(Iterator<NetworkLinkDescriptor> linkDescriptorsIterator = linkDescriptors
			        .iterator(); linkDescriptorsIterator.hasNext();)
			{
				NetworkLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
				        .next();
	 ...
	 * @generated
	 */
	private Collection<NetworkLinkDescriptor> collectAllLinks(View view,
	        Map<EObject, View> domain2NotationMap)
	{
		if(!NetworkEditPart.MODEL_ID.equals(NetworkVisualIDRegistry
		        .getModelID(view)))
		{
	...
	private Collection<IAdaptable> createConnections(
	        Collection<NetworkLinkDescriptor> linkDescriptors,
	        Map<EObject, View> domain2NotationMap)
	{
		...
		for(NetworkLinkDescriptor nextLinkDescriptor : linkDescriptors)
		{
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
			        ...
			        NetworkVisualIDRegistry.getType(nextLinkDescriptor
