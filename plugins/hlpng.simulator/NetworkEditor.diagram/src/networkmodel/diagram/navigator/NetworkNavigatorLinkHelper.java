 ...
 * @generated
 */
public class NetworkNavigatorLinkHelper implements ILinkHelper
{
	...
	{
		IDiagramDocument document = NetworkDiagramEditorPlugin.getInstance()
	        ...
	        IStructuredSelection aSelection)
	{
		...
		NetworkAbstractNavigatorItem abstractNavigatorItem = (NetworkAbstractNavigatorItem) aSelection
		        .getFirstElement();
		View navigatorView = null;
		if(abstractNavigatorItem instanceof NetworkNavigatorItem)
		{
			navigatorView = ((NetworkNavigatorItem) abstractNavigatorItem)
			        .getView();
		}
		else if(abstractNavigatorItem instanceof NetworkNavigatorGroup)
		{
			...
			{
				navigatorView = ((NetworkNavigatorItem) navigatorGroup
				        .getParent()).getView();
			}
		}
