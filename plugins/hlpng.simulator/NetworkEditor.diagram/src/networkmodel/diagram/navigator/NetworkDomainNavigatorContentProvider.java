 ...
 * @generated
 */
public class NetworkDomainNavigatorContentProvider implements
        ICommonContentProvider
{
	 ...
	 * @generated
	 */
	public NetworkDomainNavigatorContentProvider()
	{
	...
	public Object[] getChildren(Object parentElement)
	{
		...
		if(parentElement instanceof NetworkDomainNavigatorItem)
		{
			return wrapEObjects(
			        myAdapterFctoryContentProvier.getChildren(((NetworkDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement)
	{
		...
		for(int i = 0; i < objects.length; i++)
		{
			...
			{
				result.add(new NetworkDomainNavigatorItem((EObject) objects[i],
