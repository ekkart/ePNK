...
import networkmodel.diagram.part.NetworkDiagramEditor;
 ...
 * @generated
 */
public class NetworkNavigatorActionProvider extends CommonActionProvider
{
	...
	private static class OpenDiagramAction extends Action
	{
		...
		public final void selectionChanged(IStructuredSelection selection)
		{
			...
			if(selection.size() == 1)
			{
				...
				if(selectedElement instanceof NetworkNavigatorItem)
				{
					selectedElement = ((NetworkNavigatorItem) selectedElement)
					        .getView();
				}
		...
		public void run()
		{
			...
			try
			{
				page.openEditor(editorInput, NetworkDiagramEditor.ID);
			}
