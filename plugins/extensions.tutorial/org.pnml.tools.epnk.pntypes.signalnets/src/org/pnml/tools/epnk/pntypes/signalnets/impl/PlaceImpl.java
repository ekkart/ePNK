 ...
 * <ul>
 *   <li>{@link org.pnml.tools.epnk.pntypes.signalnets.impl.PlaceImpl#getMarking <em>Marking</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlaceImpl extends org.pnml.tools.epnk.pnmlcoremodel.impl.PlaceImpl implements Place {
	...
	protected EClass eStaticClass() {
		return SignalnetsPackage.Literals.PLACE;
	}
	...
	public NotificationChain basicSetMarking(Marking newMarking, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SignalnetsPackage.PLACE__MARKING, oldMarking, newMarking);
	...
	public void setMarking(Marking newMarking) {
		if (newMarking != marking) {
			...
			if (marking != null)
				msgs = ((InternalEObject)marking).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SignalnetsPackage.PLACE__MARKING, null, msgs);
			if (newMarking != null)
				msgs = ((InternalEObject)newMarking).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SignalnetsPackage.PLACE__MARKING, null, msgs);
			msgs = basicSetMarking(newMarking, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SignalnetsPackage.PLACE__MARKING, newMarking, newMarking));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SignalnetsPackage.PLACE__MARKING:
