 ...
 * <ul>
 *   <li>{@link org.pnml.tools.epnk.pntypes.signalnets.impl.MarkingImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MarkingImpl extends AttributeImpl implements Marking {
	...
	protected EClass eStaticClass() {
		return SignalnetsPackage.Literals.MARKING;
	}
	...
	public void setText(BigInteger newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SignalnetsPackage.MARKING__TEXT, oldText, text));
	}
