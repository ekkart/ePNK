...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.extensions.tutorial.types.arctypes.arctypes.Arc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArcItemProvider
	extends org.pnml.tools.epnk.pnmlcoremodel.provider.ArcItemProvider
	implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArctypesPackage.Literals.ARC__TYPE);
			childrenFeatures.add(ArctypesPackage.Literals.ARC__BOOL);
			childrenFeatures.add(ArctypesPackage.Literals.ARC__COMMENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArctypesPackage.Literals.ARC__TYPE,
				 ArctypesFactory.eINSTANCE.createArcType()));

		newChildDescriptors.add
			(createChildParameter
				(ArctypesPackage.Literals.ARC__BOOL,
				 ArctypesFactory.eINSTANCE.createBoolean()));

		newChildDescriptors.add
			(createChildParameter
				(ArctypesPackage.Literals.ARC__COMMENT,
				 ArctypesFactory.eINSTANCE.createComment()));
	}
