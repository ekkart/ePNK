...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.extensions.tutorial.types.arctypes.arctypes.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArctypesPackage.Literals.PAGE__COMMENT);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 ArctypesFactory.eINSTANCE.createArc()));

		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 ArctypesFactory.eINSTANCE.createPage()));

		newChildDescriptors.add
			(createChildParameter
				(ArctypesPackage.Literals.PAGE__COMMENT,
