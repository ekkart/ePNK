 ...
 * @generated
 */
public class PtnetsimulatorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PtnetsimulatorPackage.TRANSITION_ACTIVATION_ANNOTATION: {
			...
			case PtnetsimulatorPackage.PLACE_MARKING_ANNOTATION: {
			...
			case PtnetsimulatorPackage.PLACE_SELECTION_ANNOTATION: {
