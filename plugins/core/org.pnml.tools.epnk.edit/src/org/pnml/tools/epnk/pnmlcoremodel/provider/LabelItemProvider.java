...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.pnmlcoremodel.Label} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LabelItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PnmlcoremodelPackage.Literals.LABEL__TOOLSPECIFIC);
			childrenFeatures.add(PnmlcoremodelPackage.Literals.LABEL__GRAPHICS);
			childrenFeatures.add(PnmlcoremodelPackage.Literals.LABEL__UNKNOWN);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Label_type"); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptorsGen(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.LABEL__TOOLSPECIFIC,
				 PnmlcoremodelFactory.eINSTANCE.createToolInfoText()));

		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.LABEL__GRAPHICS,
