...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.toolspecific.diagraminfo.DiagramInfo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramInfoItemProvider
	 ...
	 * @generated
	 */
	public DiagramInfoItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagraminfoPackage.Literals.DIAGRAM_INFO__PAGE_LABEL_PROXY);
			childrenFeatures.add(DiagraminfoPackage.Literals.DIAGRAM_INFO__DIAGRAM);
			childrenFeatures.add(DiagraminfoPackage.Literals.DIAGRAM_INFO__LABEL_PROXY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DiagramInfo"));
	}
	...
	public String getText(Object object) {
		String label = ((DiagramInfo)object).getTool();
		return label == null || label.length() == 0 ?
			getString("_UI_DiagramInfo_type") :
			getString("_UI_DiagramInfo_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DiagramInfo.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagraminfoPackage.Literals.DIAGRAM_INFO__PAGE_LABEL_PROXY,
				 PnmlcoremodelFactory.eINSTANCE.createPageLabelProxy()));

		newChildDescriptors.add
			(createChildParameter
				(DiagraminfoPackage.Literals.DIAGRAM_INFO__DIAGRAM,
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagraminfoPackage.Literals.DIAGRAM_INFO__LABEL_PROXY,
	...
	public ResourceLocator getResourceLocator() {
		return PNMLPageDiagramInfoEditPlugin.INSTANCE;
	}
