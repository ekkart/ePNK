...
public class LabelProxyItemProvider
	...
	protected void addObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LabelProxy_object_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_LabelProxy_object_feature", "_UI_LabelProxy_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 PnmlcoremodelPackage.Literals.LABEL_PROXY__OBJECT,
				 false,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = crop(((LabelProxy)object).getText());
