...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.pnmlcoremodel.Name} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NameItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Name_text_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Name_text_feature", "_UI_Name_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 PnmlcoremodelPackage.Literals.NAME__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Name)object).getText();
