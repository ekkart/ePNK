...
public class PnmlcoremodelPackageImpl extends EPackageImpl implements PnmlcoremodelPackage {
	...
	public void initializePackageContents() {
		...
		pageEClass.getESuperTypes().add(this.getNode());
		...
		initEAttribute(getLine_Shape(), this.getLineShape(), "shape", "line", 0, 1, Line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		initEAttribute(getLine_Width(), ecorePackage.getEFloat(), "width", "1.0", 0, 1, Line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		initEAttribute(getFont_Size(), this.getFontSize(), "size", "9pt", 0, 1, Font.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		initEEnum(lineShapeEEnum, LineShape.class, "LineShape"); //$NON-NLS-1$
		addEEnumLiteral(lineShapeEEnum, LineShape.LINE);
		addEEnumLiteral(lineShapeEEnum, LineShape.CURVE);

		// Initialize data types
		initEDataType(colorEDataType, CSSColor.class, "Color", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEDataType(lineStyleEDataType, NotImplemented.class, "LineStyle", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEDataType(uriEDataType, org.pnml.tools.epnk.graphics.datatypes.URI.class, "URI", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		...
		initEDataType(fontFamilyEDataType, CSSFontFamily.class, "FontFamily", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		...
		initEDataType(fontSizeEDataType, CSSFontSize.class, "FontSize", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
