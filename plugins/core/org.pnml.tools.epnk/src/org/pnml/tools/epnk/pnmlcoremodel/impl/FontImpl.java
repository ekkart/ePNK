...
public class FontImpl extends EObjectImpl implements Font {
	 ...
	 * @ordered
	 */
	protected static final CSSFontFamily FAMILY_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected CSSFontFamily family = FAMILY_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final CSSFontSize SIZE_EDEFAULT = (CSSFontSize)PnmlcoremodelFactory.eINSTANCE.createFromString(PnmlcoremodelPackage.eINSTANCE.getFontSize(), "9pt");
	 ...
	 * @ordered
	 */
	protected CSSFontSize size = SIZE_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setFamily(CSSFontFamily newFamily) {
		CSSFontFamily oldFamily = family;
		family = newFamily;
	 ...
	 * @generated
	 */
	public void setSize(CSSFontSize newSize) {
		CSSFontSize oldSize = size;
		size = newSize;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case PnmlcoremodelPackage.FONT__FAMILY:
				setFamily((CSSFontFamily)newValue);
				return;
			case PnmlcoremodelPackage.FONT__STYLE:
