...
public class PnmlcoremodelFactoryImpl extends EFactoryImpl implements PnmlcoremodelFactory {
	 ...
	 * @generated
	 */
	public CSSColor createColorFromString(EDataType eDataType, String initialValue) {
		return (CSSColor)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public CSSFontFamily createFontFamilyFromString(EDataType eDataType, String initialValue) {
		return (CSSFontFamily)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public CSSFontSize createFontSizeFromString(EDataType eDataType, String initialValue) {
		return (CSSFontSize)super.createFromString(eDataType, initialValue);
	}
