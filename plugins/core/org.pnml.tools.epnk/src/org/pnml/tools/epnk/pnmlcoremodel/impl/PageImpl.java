...
public class PageImpl extends NodeImpl implements Page {
	...
	/**
	 * Returns true, if the label at the feature should be shown in the pages
	 * content. Returns false, if the label for the feature should be shown
	 * as a label of the page node on the super page. By standard, features with
	 * multiplicity "*" will be shown on the page; other features will be
	 * shown as labels of the page node on the super page.
	 * 
	 * @generated NOT
	 * @author eki
	 */
	@Override
	public boolean showLabelOnPage(EReference feature) {
