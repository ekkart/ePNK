...
public class FillImpl extends EObjectImpl implements Fill {
	 ...
	 * @ordered
	 */
	protected static final CSSColor COLOR_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected CSSColor color = COLOR_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final CSSColor GRADIENT_COLOR_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected CSSColor gradientColor = GRADIENT_COLOR_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setColor(CSSColor newColor) {
		CSSColor oldColor = color;
		color = newColor;
	 ...
	 * @generated
	 */
	public CSSColor getGradientColor() {
	 ...
	 * @generated
	 */
	public void setGradientColor(CSSColor newGradientColor) {
		CSSColor oldGradientColor = gradientColor;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case PnmlcoremodelPackage.FILL__COLOR:
				setColor((CSSColor)newValue);
				return;
			case PnmlcoremodelPackage.FILL__IMAGE:
				setImage((URI)newValue);
				return;
			case PnmlcoremodelPackage.FILL__GRADIENT_COLOR:
				setGradientColor((CSSColor)newValue);
				return;
			case PnmlcoremodelPackage.FILL__GRADIENTROTATION:
