 ...
 * @author vramaswa
 */
public final class GlobalRedoActionNoPrune extends GlobalAction
{
	 ...
	 *            the page
	 */
	public GlobalRedoActionNoPrune(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}
	 ...
	 *            the part
	 */
	public GlobalRedoActionNoPrune(IWorkbenchPart workbenchPart) {
		super(workbenchPart);
	}
