 ...
 * @author cmahoney
 * 
 * @ekki@dtu.dk, March 20, 2016:
 * The GMF PopupMenu did not work under Windows 10, which is a know bug:
 * See https://bugs.eclipse.org/bugs/show_bug.cgi?id=480318
 * and https://bugs.eclipse.org/bugs/show_bug.cgi?id=485619
 * 
 * I included a hopefully temporary fix here for the ePNK as a work around for
 * the use of the PopupMenu in the ePNK for the course MBSE at DTU. I hope that
 * this will be fixed in GMF in the next official release. Then this can be 
 * removed again.
 */
public class PopupMenu {
	...
	public boolean show(Control parent) {
		...
		// ekki@dtu.dk, March 20, 2016:
		//   Fixed this temporarily as long as this fix is
		//   not included in the officially released versions of GMF.
		//   See https://bugs.eclipse.org/bugs/show_bug.cgi?id=480318
		//   and https://bugs.eclipse.org/bugs/show_bug.cgi?id=485619
		//
		// FIXME ekki@dtu.dk: this complete class should eventually be removed again, when this bug is fixed in the official release of GMF
		//   in org.eclipse.gmf.runtime.diagram.ui.menus.PopupMenu
