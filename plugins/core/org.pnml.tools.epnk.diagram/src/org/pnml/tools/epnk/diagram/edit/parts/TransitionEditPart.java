...
import org.pnml.tools.epnk.diagram.edit.policies.TransitionItemSemanticEditPolicy;
...
public class TransitionEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		...
		if (model instanceof View) {
			...
			EObject transition = view.getElement();
			if (transition != null && transition instanceof Transition) {
				figure = FigureExtensionsRegistry.getInstance()
						.createTransition((Transition) transition);
			}
		}
		if (figure == null) {
			figure = new org.pnml.tools.epnk.gmf.extensions.graphics.figures.TransitionFigure(
					null);
		}
	...
	/**
	 * @generated NOT
	 * @author eki (changed return type from TransitionFigure to IUpdateableFigure)
	 */
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.pnml.tools.epnk.diagram.edit.parts.TransitionEditPart) {
			types.add(PNMLCoreModelElementTypes.Arc_4001);
		}
	 ...
	 * @author eki
	 */
	public abstract class TransitionFigure extends RectangleFigure {
