 ...
 * @generated
 */
public class PNMLCoreModelDomainNavigatorContentProvider implements
	...
	public PNMLCoreModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof PNMLCoreModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((PNMLCoreModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new PNMLCoreModelDomainNavigatorItem(
