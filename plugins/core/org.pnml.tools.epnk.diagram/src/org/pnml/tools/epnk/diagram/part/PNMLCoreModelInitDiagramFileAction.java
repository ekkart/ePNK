 ...
 * @generated
 */
public class PNMLCoreModelInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new PNMLCoreModelNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				PageEditPart.MODEL_ID));
		PNMLCoreModelDiagramEditorUtil.runWizard(getShell(), wizard,
