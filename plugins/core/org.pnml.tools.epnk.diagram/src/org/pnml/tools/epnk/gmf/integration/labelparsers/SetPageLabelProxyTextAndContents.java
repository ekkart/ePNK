...
// @generated NOT
// @author eki
public class SetPageLabelProxyTextAndContents extends AbstractTransactionalCommand {

	private PageLabelProxy proxy;
	private String text;
	private EObject structure;
	
	public SetPageLabelProxyTextAndContents(PageLabelProxy proxy, String text, EObject structure) { 
