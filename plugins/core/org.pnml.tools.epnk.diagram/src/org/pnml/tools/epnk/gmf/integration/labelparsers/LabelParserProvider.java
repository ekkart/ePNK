...
// @generated NOT
// @author eki
public class LabelParserProvider extends AbstractProvider implements
		IParserProvider {
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			*/
			...
			return hint.getAdapter(EObject.class) instanceof LabelProxy; 
		}
		return false;
	}
