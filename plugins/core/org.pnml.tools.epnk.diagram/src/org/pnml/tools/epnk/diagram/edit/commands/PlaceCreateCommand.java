...
public class PlaceCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		// Place newElement = PnmlcoremodelFactory.eINSTANCE.createPlace();

		Page owner = (Page) getElementToEdit();
		Place newElement = null;
		PetriNetType type = NetFunctions.getPetriNetType(owner);
		if (type != null) {
			newElement = type.createPlace();
		} else {
			newElement = PnmlcoremodelFactory.eINSTANCE.createPlace();
		}
		// end replaced text.
	 ...
	 * @generated
	 */
	protected void doConfigure(Place newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
