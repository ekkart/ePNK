 ...
 * @generated
 */
public class ParserrulesSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ParserrulesPackage.RULES: {
				Rules rules = (Rules)theEObject;
				T result = caseRules(rules);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.RULE: {
				Rule rule = (Rule)theEObject;
				T result = caseRule(rule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.ITERATOR: {
				Iterator iterator = (Iterator)theEObject;
				T result = caseIterator(iterator);
				if (result == null) result = caseRule(iterator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.CLASS_REF: {
				ClassRef classRef = (ClassRef)theEObject;
				T result = caseClassRef(classRef);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.CHOICE: {
				Choice choice = (Choice)theEObject;
				T result = caseChoice(choice);
				if (result == null) result = caseRule(choice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.OP: {
				Op op = (Op)theEObject;
				T result = caseOp(op);
				if (result == null) result = caseRule(op);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.ATOM: {
				Atom atom = (Atom)theEObject;
				T result = caseAtom(atom);
				if (result == null) result = caseRule(atom);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.TOKEN: {
				Token token = (Token)theEObject;
				T result = caseToken(token);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.SEQUENCE: {
			...
			case ParserrulesPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = caseRule(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.SYMBOL: {
				Symbol symbol = (Symbol)theEObject;
				T result = caseSymbol(symbol);
				if (result == null) result = caseRule(symbol);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.PARENTHESIS: {
				Parenthesis parenthesis = (Parenthesis)theEObject;
				T result = caseParenthesis(parenthesis);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.OPEN: {
				Open open = (Open)theEObject;
				T result = caseOpen(open);
				if (result == null) result = caseParenthesis(open);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.CLOSE: {
				Close close = (Close)theEObject;
				T result = caseClose(close);
				if (result == null) result = caseParenthesis(close);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.SEPARATOR: {
				Separator separator = (Separator)theEObject;
				T result = caseSeparator(separator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParserrulesPackage.CONDITIONAL: {
				Conditional conditional = (Conditional)theEObject;
				T result = caseConditional(conditional);
				if (result == null) result = caseRule(conditional);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
