 ...
 * <ul>
 *   <li>{@link parserrules.impl.SymbolImpl#getToken <em>Token</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SymbolImpl extends RuleImpl implements Symbol {
	/**
	...
	protected EClass eStaticClass() {
		return ParserrulesPackage.Literals.SYMBOL;
	}
		...
		if (token != null && token.eIsProxy()) {
			...
			if (token != oldToken) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParserrulesPackage.SYMBOL__TOKEN, oldToken, token));
			}
		}
		return token;
	}
	...
	public void setToken(Token newToken) {
		...
		token = newToken;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParserrulesPackage.SYMBOL__TOKEN, oldToken, token));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParserrulesPackage.SYMBOL__TOKEN:
