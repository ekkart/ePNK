 ...
 * <!-- end-user-doc -->
 * @see parserrules.ParserrulesPackage#getOpType()
 * @model
 * @generated
 */
public enum OpType implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<OpType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
