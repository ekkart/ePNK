...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.HLAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HLAnnotationItemProvider
	 ...
	 * @generated
	 */
	public HLAnnotationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HlpngdefinitionPackage.Literals.HL_ANNOTATION__STRUCTURE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HLAnnotation")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = crop(((HLAnnotation)object).getText());
		return label == null || label.length() == 0 ?
			getString("_UI_HLAnnotation_type") : //$NON-NLS-1$
			getString("_UI_HLAnnotation_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HLAnnotation.class)) {
			case HlpngdefinitionPackage.HL_ANNOTATION__STRUCTURE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HlpngdefinitionPackage.Literals.HL_ANNOTATION__STRUCTURE,
