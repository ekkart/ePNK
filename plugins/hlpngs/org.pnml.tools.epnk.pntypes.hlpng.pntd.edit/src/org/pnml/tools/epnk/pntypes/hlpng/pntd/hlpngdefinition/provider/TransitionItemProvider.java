...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider
	extends org.pnml.tools.epnk.pnmlcoremodel.provider.TransitionItemProvider
	implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HlpngdefinitionPackage.Literals.TRANSITION__CONDITION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Transition.class)) {
			case HlpngdefinitionPackage.TRANSITION__CONDITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HlpngdefinitionPackage.Literals.TRANSITION__CONDITION,
				 HlpngdefinitionFactory.eINSTANCE.createCondition()));
	}
