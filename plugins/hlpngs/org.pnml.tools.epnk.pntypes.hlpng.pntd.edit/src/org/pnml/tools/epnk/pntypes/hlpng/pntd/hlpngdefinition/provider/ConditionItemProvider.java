...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HlpngdefinitionPackage.Literals.CONDITION__STRUCTURE);
		}
	...
	public String getText(Object object) {
		String label = crop(((Condition)object).getText());
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Condition.class)) {
			case HlpngdefinitionPackage.CONDITION__STRUCTURE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HlpngdefinitionPackage.Literals.CONDITION__STRUCTURE,
