	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BooleansPackage.EQUALITY: {
				...
				if (result == null) result = caseBuiltInOperator(equality);
				if (result == null) result = caseOperator(equality);
				if (result == null) result = caseTerm(equality);
			...
			case BooleansPackage.INEQUALITY: {
				...
				if (result == null) result = caseBuiltInOperator(inequality);
				if (result == null) result = caseOperator(inequality);
				if (result == null) result = caseTerm(inequality);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BooleansPackage.BOOL: {
				...
				if (result == null) result = caseBuiltInSort(bool);
				if (result == null) result = caseSort(bool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BooleansPackage.BOOLEAN_OPERATOR: {
				...
				if (result == null) result = caseBuiltInOperator(booleanOperator);
				if (result == null) result = caseOperator(booleanOperator);
				if (result == null) result = caseTerm(booleanOperator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BooleansPackage.OR: {
				...
				if (result == null) result = caseBuiltInOperator(or);
			...
			case BooleansPackage.AND: {
				...
				if (result == null) result = caseBuiltInOperator(and);
			...
			case BooleansPackage.IMPLY: {
				...
				if (result == null) result = caseBooleanOperator(imply);
				if (result == null) result = caseBuiltInOperator(imply);
				if (result == null) result = caseOperator(imply);
				if (result == null) result = caseTerm(imply);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BooleansPackage.NOT: {
				...
				if (result == null) result = caseBuiltInOperator(not);
			...
			case BooleansPackage.BOOLEAN_CONSTANT: {
				...
				if (result == null) result = caseBuiltInConst(booleanConstant);
				if (result == null) result = caseOperator(booleanConstant);
				if (result == null) result = caseTerm(booleanConstant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
