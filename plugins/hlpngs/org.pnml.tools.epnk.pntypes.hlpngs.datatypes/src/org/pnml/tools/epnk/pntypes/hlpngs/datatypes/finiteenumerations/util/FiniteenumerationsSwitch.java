 ...
 * @generated
 */
public class FiniteenumerationsSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FiniteenumerationsPackage.FINITE_ENUMERATION: {
				...
				if (result == null) result = caseBuiltInSort(finiteEnumeration);
				if (result == null) result = caseSort(finiteEnumeration);
			...
			case FiniteenumerationsPackage.FE_CONSTANT: {
				...
				if (result == null) result = caseOperatorDecl(feConstant);
				if (result == null) result = caseDeclaration(feConstant);
				if (result == null) result = caseSymbolDef(feConstant);
				if (result == null) result = caseID(feConstant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>FE Constant</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>FE Constant</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
