 ...
 * @generated
 */
public class PartitionsSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PartitionsPackage.PARTITION: {
				...
				if (result == null) result = caseSortDecl(partition);
				if (result == null) result = caseDeclaration(partition);
				if (result == null) result = caseSymbolDef(partition);
				if (result == null) result = caseID(partition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PartitionsPackage.PARTITION_ELEMENT: {
				PartitionElement partitionElement = (PartitionElement)theEObject;
				T result = casePartitionElement(partitionElement);
				if (result == null) result = caseOperatorDecl(partitionElement);
				if (result == null) result = caseDeclaration(partitionElement);
				if (result == null) result = caseSymbolDef(partitionElement);
				if (result == null) result = caseID(partitionElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PartitionsPackage.PARTITION_OPERATOR: {
				PartitionOperator partitionOperator = (PartitionOperator)theEObject;
				T result = casePartitionOperator(partitionOperator);
				if (result == null) result = caseBuiltInOperator(partitionOperator);
				if (result == null) result = caseOperator(partitionOperator);
				if (result == null) result = caseTerm(partitionOperator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PartitionsPackage.PARTITION_ELEMENT_OF: {
				PartitionElementOf partitionElementOf = (PartitionElementOf)theEObject;
				T result = casePartitionElementOf(partitionElementOf);
				if (result == null) result = casePartitionOperator(partitionElementOf);
				if (result == null) result = caseSymbolUse(partitionElementOf);
				if (result == null) result = caseBuiltInOperator(partitionElementOf);
				if (result == null) result = caseOperator(partitionElementOf);
				if (result == null) result = caseTerm(partitionElementOf);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PartitionsPackage.LESS_THAN: {
				...
				if (result == null) result = casePartitionOperator(lessThan);
			...
			case PartitionsPackage.GREATER_THAN: {
				...
				if (result == null) result = casePartitionOperator(greaterThan);
	 ...
	 * @generated
	 */
	public T casePartitionElement(PartitionElement object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePartitionOperator(PartitionOperator object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePartitionElementOf(PartitionElementOf object) {
		return null;
	}
