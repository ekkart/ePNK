 ...
 * <ul>
 *   <li>{@link org.pnml.tools.epnk.pntypes.hlpngs.datatypes.lists.impl.EmptyListImpl#getRefsort <em>Refsort</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EmptyListImpl extends BuiltInConstImpl implements EmptyList {
	/**
	...
	protected EClass eStaticClass() {
		return ListsPackage.Literals.EMPTY_LIST;
	}
	...
	public NotificationChain basicSetRefsort(Sort newRefsort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ListsPackage.EMPTY_LIST__REFSORT, oldRefsort, newRefsort);
	...
	public void setRefsort(Sort newRefsort) {
		if (newRefsort != refsort) {
			...
			if (refsort != null)
				msgs = ((InternalEObject)refsort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ListsPackage.EMPTY_LIST__REFSORT, null, msgs);
			if (newRefsort != null)
				msgs = ((InternalEObject)newRefsort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ListsPackage.EMPTY_LIST__REFSORT, null, msgs);
			msgs = basicSetRefsort(newRefsort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ListsPackage.EMPTY_LIST__REFSORT, newRefsort, newRefsort));
	}
