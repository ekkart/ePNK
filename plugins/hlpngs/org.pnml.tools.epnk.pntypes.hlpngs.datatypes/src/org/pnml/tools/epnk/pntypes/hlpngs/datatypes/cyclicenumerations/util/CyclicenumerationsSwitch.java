 ...
 * @generated
 */
public class CyclicenumerationsSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CyclicenumerationsPackage.CYCLIC_ENUMERATION: {
				...
				if (result == null) result = caseFiniteEnumeration(cyclicEnumeration);
				if (result == null) result = caseBuiltInSort(cyclicEnumeration);
				if (result == null) result = caseSort(cyclicEnumeration);
			...
			case CyclicenumerationsPackage.CYCLIC_ENUM_OPERATOR: {
				...
				if (result == null) result = caseBuiltInOperator(cyclicEnumOperator);
				if (result == null) result = caseOperator(cyclicEnumOperator);
				if (result == null) result = caseTerm(cyclicEnumOperator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyclicenumerationsPackage.SUCCESSOR: {
				...
				if (result == null) result = caseCyclicEnumOperator(successor);
				if (result == null) result = caseBuiltInOperator(successor);
				if (result == null) result = caseOperator(successor);
				if (result == null) result = caseTerm(successor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyclicenumerationsPackage.PREDECESSOR: {
				...
				if (result == null) result = caseCyclicEnumOperator(predecessor);
				if (result == null) result = caseBuiltInOperator(predecessor);
				if (result == null) result = caseOperator(predecessor);
				if (result == null) result = caseTerm(predecessor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
