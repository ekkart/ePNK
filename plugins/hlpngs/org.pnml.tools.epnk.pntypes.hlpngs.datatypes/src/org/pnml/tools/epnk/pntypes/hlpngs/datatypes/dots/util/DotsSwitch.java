...
public class DotsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DotsPackage.DOT: {
				...
				if (result == null) result = caseBuiltInSort(dot);
				if (result == null) result = caseSort(dot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DotsPackage.DOT_CONSTANT: {
				DotConstant dotConstant = (DotConstant)theEObject;
				T result = caseDotConstant(dotConstant);
				if (result == null) result = caseBuiltInConst(dotConstant);
				if (result == null) result = caseOperator(dotConstant);
				if (result == null) result = caseTerm(dotConstant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDotConstant(DotConstant object) {
		return null;
	}
