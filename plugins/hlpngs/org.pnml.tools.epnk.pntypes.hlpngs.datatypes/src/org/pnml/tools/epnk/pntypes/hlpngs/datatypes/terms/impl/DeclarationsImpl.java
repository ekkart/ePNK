 ...
 * <ul>
 *   <li>{@link org.pnml.tools.epnk.pntypes.hlpngs.datatypes.terms.impl.DeclarationsImpl#getDeclaration <em>Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DeclarationsImpl extends EObjectImpl implements Declarations {
	/**
	...
	public EList<Declaration> getDeclaration() {
		if (declaration == null) {
			declaration = new EObjectContainmentEList<Declaration>(Declaration.class, this, TermsPackage.DECLARATIONS__DECLARATION);
		}
		return declaration;
	}
