...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.pntypes.hlpngs.datatypes.terms.Declaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeclarationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SymbolDef_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SymbolDef_name_feature", "_UI_SymbolDef_type"),
				 StructuredpntypemodelPackage.Literals.SYMBOL_DEF__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Declaration.class)) {
			case TermsPackage.DECLARATION__ID:
			case TermsPackage.DECLARATION__NAME:
