...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.pntypes.hlpngs.datatypes.terms.NamedSort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedSortItemProvider
	 ...
	 * @generated
	 */
	public NamedSortItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TermsPackage.Literals.NAMED_SORT__DEF);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NamedSort"));
	}
	...
	public String getText(Object object) {
		String label = ((NamedSort)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_NamedSort_type") :
			getString("_UI_NamedSort_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NamedSort.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TermsPackage.Literals.NAMED_SORT__DEF,
