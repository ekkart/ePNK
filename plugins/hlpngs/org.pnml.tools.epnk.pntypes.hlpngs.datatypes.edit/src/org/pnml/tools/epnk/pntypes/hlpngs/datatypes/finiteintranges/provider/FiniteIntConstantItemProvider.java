...
/**
 * This is the item provider adapter for a {@link org.pnml.tools.epnk.pntypes.hlpngs.datatypes.finiteintranges.FiniteIntConstant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FiniteIntConstantItemProvider
	 ...
	 * @generated
	 */
	public FiniteIntConstantItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FiniteIntConstant_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FiniteIntConstant_value_feature", "_UI_FiniteIntConstant_type"),
				 FiniteintrangesPackage.Literals.FINITE_INT_CONSTANT__VALUE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FiniteintrangesPackage.Literals.FINITE_INT_CONSTANT__RANGE);
		}
	...
	/**
	 * This returns FiniteIntConstant.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FiniteIntConstant"));
	}
	...
	public String getText(Object object) {
		FiniteIntConstant finiteIntConstant = (FiniteIntConstant)object;
		return getString("_UI_FiniteIntConstant_type") + " " + finiteIntConstant.getValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FiniteIntConstant.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FiniteintrangesPackage.Literals.FINITE_INT_CONSTANT__RANGE,
				 FiniteintrangesFactory.eINSTANCE.createFiniteIntRange()));
	}
