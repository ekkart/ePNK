...
public interface HlpngdefinitionPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.impl.HLPNImpl <em>HLPN</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.impl.HLPNImpl
	 * @see org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.impl.HlpngdefinitionPackageImpl#getHLPN()
	 * @generated
	 */
	int HLPN = 10;
	 ...
	 * @ordered
	 */
	int HLPN__ID = PnmlcoremodelPackage.PETRI_NET__ID;
	 ...
	 * @ordered
	 */
	int HLPN__TYPE = PnmlcoremodelPackage.PETRI_NET__TYPE;
	 ...
	 * @ordered
	 */
	int HLPN__NAME = PnmlcoremodelPackage.PETRI_NET__NAME;
	 ...
	 * @ordered
	 */
	int HLPN__PAGE = PnmlcoremodelPackage.PETRI_NET__PAGE;
	 ...
	 * @ordered
	 */
	int HLPN__TOOLSPECIFIC = PnmlcoremodelPackage.PETRI_NET__TOOLSPECIFIC;
	 ...
	 * @ordered
	 */
	int HLPN__UNKNOWN = PnmlcoremodelPackage.PETRI_NET__UNKNOWN;
	 ...
	 * @ordered
	 */
	int HLPN__DECLARATION = PnmlcoremodelPackage.PETRI_NET_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>HLPN</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int HLPN_FEATURE_COUNT = PnmlcoremodelPackage.PETRI_NET_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for class '{@link org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.HLPN <em>HLPN</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>HLPN</em>'.
	...
	/**
	 * Returns the meta object for the containment reference list '{@link org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.HLPN#getDeclaration <em>Declaration</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Declaration</em>'.
	 * @see org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.HLPN#getDeclaration()
	 * @see #getHLPN()
	 * @generated
	 */
	EReference getHLPN_Declaration();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.impl.HLPNImpl <em>HLPN</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.impl.HLPNImpl
		 * @see org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.impl.HlpngdefinitionPackageImpl#getHLPN()
		 ...
		 * @generated
		 */
		EReference HLPN__DECLARATION = eINSTANCE.getHLPN_Declaration();
