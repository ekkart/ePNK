...
public class HlpngdefinitionPackageImpl extends EPackageImpl implements HlpngdefinitionPackage {
	 ...
	 * @generated
	 */
	private EClass hlpnEClass = null;
	 ...
	 * @generated
	 */
	public EReference getHLPN_Declaration() {
		return (EReference)hlpnEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		hlpnEClass = createEClass(HLPN);
		createEReference(hlpnEClass, HLPN__DECLARATION);
	...
	public void initializePackageContents() {
		...
		hlpnEClass.getESuperTypes().add(thePnmlcoremodelPackage.getPetriNet());
		...
		initEClass(hlpnEClass, org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.HLPN.class, "HLPN", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getHLPN_Declaration(), this.getDeclaration(), null, "declaration", null, 0, -1, org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.HLPN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
