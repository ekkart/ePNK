	...
	public EObject createObject(EStructuralFeature feature, Object container,
		...
		if (feature != null &&
			...
			*/
			...
			// May 7, 2013, ekki: test whether the new solution without specific
			//                    subclasses of the AssocClass works
			//
			// TODO If this works reliably, eventually all the TermAssoc and other specific
			//      subclasses of assoc can be removed
			AssocClass assoc= SerialisationFactory.eINSTANCE.createAssocClass();
			assoc.eSet(SerialisationPackage.eINSTANCE.getAssocClass_Source(), (Operator) container);
			assoc.eSet(SerialisationPackage.eINSTANCE.getAssocClass_Feature(), feature);
			return assoc;
		}
